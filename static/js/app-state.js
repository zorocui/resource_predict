(function () {
  ...
  window.ResourcePredictApp = {
    ...
    els: {
      ...
      updateSource: document.getElementById("update-source"),
      updateWindow: document.getElementById("update-window"),
      ...
      k8sScheduleHint: document.getElementById("k8s-schedule-hint"),
      collectionConfigList: document.getElementById("collection-config-list"),
      predictionConfigList: document.getElementById("prediction-config-list"),
      decisionConfigList: document.getElementById("decision-config-list"),
