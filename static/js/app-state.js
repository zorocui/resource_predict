(function () {
  ...
  window.ResourcePredictApp = {
    ...
    labelMap: { arima: "ARIMA", sarima: "SARIMA", prophet: "Prophet", seasonal_naive: "Seasonal naive", rolling_mean: "Rolling mean", ensemble: "Ensemble", lstm: "LSTM" },
    colorMap: { arima: "#2563eb", sarima: "#059669", prophet: "#d97706", seasonal_naive: "#7c3aed", rolling_mean: "#64748b", ensemble: "#0f172a", lstm: "#db2777" },
