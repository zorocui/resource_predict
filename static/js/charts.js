(function () {
  ...
  function renderAdvice(resource) {
    ...
    app.els.detailConfidence.innerHTML = `置信度 ${list.escapeHtml(list.confidenceText(resource))}${historyLabel ? ` · ${list.escapeHtml(historyLabel)}` : ""} ${list.infoTooltip(list.confidenceTooltip(resource), "置信度计算说明")}`;
