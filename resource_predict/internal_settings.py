...
class SettingsProxy:
    ...
    def generation(self) -> GenerationConfig:
        ...
        return replace(
            ...
            workload_future_duration=cfg.workload_future_duration,
        )
    ...
    def decision(self) -> DecisionConfig:
        ...
        return replace(_internal_settings.decision, **cfg.__dict__)
    ...
    def k8s_prometheus(self) -> K8SPrometheusConfig:
        ...
        return replace(
            ...
            scheduled_update_interval_minutes=cfg.scheduled_update_interval_minutes,
